...
const Comments = ({ postId }) => {
  ...
  return (
    <Model setModel={setShowComment} model={showComment}>
    ...
    {/* comment from */}
    {currentUser && (
        <div className="shadows p-3 my-5 overflow-hidden rounded-md">
            ...
            <textarea
                ...
                className="w-full outline-none resize-none text-sm border rounded-sm px-2 pt-4"></textarea> 
